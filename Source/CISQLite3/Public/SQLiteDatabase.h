...
private:
	...
	static bool IsValidDatabase(FString DatabaseFilename, bool TestByOpening, FString dbName = "");
	/** Tries to open a database. */
	static bool CanOpenDatabase(FString DatabaseFilename, FString dbName = "");
